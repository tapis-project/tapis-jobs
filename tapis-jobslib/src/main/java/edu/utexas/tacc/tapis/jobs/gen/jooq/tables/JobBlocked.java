...
public class JobBlocked extends TableImpl<JobBlockedRecord> {
    ...
    /**
     * The reference instance of <code>tapis_jobs.job_blocked</code>
     */
    ...
    /**
     * The column <code>tapis_jobs.job_blocked.id</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_blocked.recovery_id</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_blocked.created</code>.
     */
    public final TableField<JobBlockedRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>tapis_jobs.job_blocked.success_status</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_blocked.job_uuid</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_blocked.status_message</code>.
     */
    ...
    /**
     * Create an aliased <code>tapis_jobs.job_blocked</code> table reference
     */
    ...
    /**
     * Create a <code>tapis_jobs.job_blocked</code> table reference
     */
    public JobBlocked() {
    ...
    /**
     * Get the implicit join path to the <code>tapis_jobs.job_recovery</code>
     * table.
     */
