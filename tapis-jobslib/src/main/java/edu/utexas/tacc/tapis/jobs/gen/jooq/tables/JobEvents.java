...
public class JobEvents extends TableImpl<JobEventsRecord> {
    ...
    /**
     * The reference instance of <code>tapis_jobs.job_events</code>
     */
    ...
    /**
     * The column <code>tapis_jobs.job_events.id</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_events.event</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_events.created</code>.
     */
    public final TableField<JobEventsRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>tapis_jobs.job_events.job_uuid</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_events.event_detail</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_events.tenant</code>.
     */
    ...
    /**
     * Create an aliased <code>tapis_jobs.job_events</code> table reference
     */
    ...
    /**
     * Create a <code>tapis_jobs.job_events</code> table reference
     */
    public JobEvents() {
