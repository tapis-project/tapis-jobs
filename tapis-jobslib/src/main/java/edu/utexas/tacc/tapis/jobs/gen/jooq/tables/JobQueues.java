...
public class JobQueues extends TableImpl<JobQueuesRecord> {
    ...
    /**
     * The reference instance of <code>tapis_jobs.job_queues</code>
     */
    ...
    /**
     * The column <code>tapis_jobs.job_queues.id</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_queues.name</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_queues.priority</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_queues.filter</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_queues.uuid</code>.
     */
    public final TableField<JobQueuesRecord, String> UUID = createField(DSL.name("uuid"), SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>tapis_jobs.job_queues.created</code>.
     */
    public final TableField<JobQueuesRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>tapis_jobs.job_queues.last_updated</code>.
     */
    public final TableField<JobQueuesRecord, LocalDateTime> LAST_UPDATED = createField(DSL.name("last_updated"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");
    ...
    /**
     * Create an aliased <code>tapis_jobs.job_queues</code> table reference
     */
    ...
    /**
     * Create a <code>tapis_jobs.job_queues</code> table reference
     */
    public JobQueues() {
