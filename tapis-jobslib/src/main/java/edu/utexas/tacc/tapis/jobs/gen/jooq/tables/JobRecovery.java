...
public class JobRecovery extends TableImpl<JobRecoveryRecord> {
    ...
    /**
     * The reference instance of <code>tapis_jobs.job_recovery</code>
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.id</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.tenant_id</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.condition_code</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.tester_type</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.tester_parms</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.policy_type</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.policy_parms</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.num_attempts</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.next_attempt</code>.
     */
    ...
    /**
     * The column <code>tapis_jobs.job_recovery.created</code>.
     */
    public final TableField<JobRecoveryRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>tapis_jobs.job_recovery.last_updated</code>.
     */
    public final TableField<JobRecoveryRecord, LocalDateTime> LAST_UPDATED = createField(DSL.name("last_updated"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>tapis_jobs.job_recovery.tester_hash</code>.
     */
    ...
    /**
     * Create an aliased <code>tapis_jobs.job_recovery</code> table reference
     */
    ...
    /**
     * Create a <code>tapis_jobs.job_recovery</code> table reference
     */
    public JobRecovery() {
