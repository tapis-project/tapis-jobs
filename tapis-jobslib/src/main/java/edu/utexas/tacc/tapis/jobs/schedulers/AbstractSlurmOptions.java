...
/** This class provides methods that can be used both in a combined cmd/stager design,
 * such as that used in the zip runtime support, or in a separate cmd/stager design,
 * such as that used in the singularity slurm runtime.  
 * 
 * @author rcardone
 */
public abstract class AbstractSlurmOptions
{
    /* ********************************************************************** */
    /*                              Constants                                 */
    /* ********************************************************************** */
    // Local logger.
    private static final Logger _log = LoggerFactory.getLogger(AbstractSlurmOptions.class);
    ...
    /* Constructor:                                                           */
    /* ---------------------------------------------------------------------- */
    public AbstractSlurmOptions(JobExecutionContext jobCtx) {_jobCtx = jobCtx;}
    ...
    /* initializeSkipList:                                                    */
    /* ---------------------------------------------------------------------- */
    protected void initializeSkipList()
    {
