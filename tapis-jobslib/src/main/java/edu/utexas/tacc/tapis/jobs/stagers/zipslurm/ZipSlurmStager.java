  ...
  extends AbstractJobExecStager
{
    ...
    private final ZipSlurmCmd _slurmRunCmd;
     ...
     * @throws TapisException
     */
    private ZipSlurmCmd configureSlurmRunCmd()
     throws TapisException
    {
        // Populate the slurm command with user specified options.
        var slurmCmd = new ZipSlurmCmd(_jobCtx);
     ...
     * @throws TapisException 
     */
    private void  setTapisOptionsForSlurm(ZipSlurmCmd slurmCmd)
     throws TapisException
    {
        // --------------------- Tapis Mandatory ---------------------
     ...
     */
    private void setUserSlurmOptions(ZipSlurmCmd slurmCmd)
     throws JobException
    {
     ...
     */
    private void assignCmd(ZipSlurmCmd slurmCmd, String option, String value)
     throws JobException
    {
        switch (option) {
